...
class AuthRepoImpl extends AuthRepo{
  ...
  @override
  Future<Either<Failure, AuthEntity>> createUserWithEmailAndPassword({required String uid, required String name, required String email, required String password}) async {
    try {
      User user = await firebaseAuthServices.createUserWithEmailAndPassword(email: email, password: password,name: name);
  ...
  @override
  Future<Either<Failure, AuthEntity>> loginWithEmailAndPassword({required String email, required String password}) async {
    try {
